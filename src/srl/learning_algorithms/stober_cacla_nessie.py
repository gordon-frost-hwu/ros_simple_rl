...
results_to_validate = ["/tmp/test0"]
                       # "/tmp/repeat_ann_32hidden_true_random_init_8lambda21",
                       # "/tmp/repeat_ann_32hidden_true_random_init_8lambda22",
                       # "/tmp/repeat_ann_32hidden_true_random_init_8lambda23",
                       # "/tmp/repeat_ann_32hidden_true_random_init_8lambda24"]
if CONFIG["test_policy"]:
    CONFIG["policy_test_type"] = "vali"
    # CONFIG["policy_test_type"] = "nessie"
    # CONFIG["policy_test_type"] = "online_nessie"
    CONFIG["policy_test_index"] = 10
        ...
        for episode_number in range(CONFIG["num_episodes"]):
            ...
            if CONFIG["test_policy"]:
                ...
                if CONFIG["policy_test_type"] == "online_nessie" and episode_number == 0:
                    ...
                    if CONFIG["policy_test_type"] == "vali":
                        policy_to_load = "{0}/policy_params{1}.npy".format(CONFIG["dir_of_policies_to_load"], 15)
