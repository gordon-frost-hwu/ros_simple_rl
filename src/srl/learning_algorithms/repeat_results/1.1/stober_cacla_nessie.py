...
results_to_validate = ["/tmp/nessie_linear_no_surge_two_dim_poly30"]
                       # "/tmp/nessie_no_surge_1dim_enac4"]
if CONFIG["test_policy"]:
    # CONFIG["policy_test_type"] = "vali"
    CONFIG["policy_test_type"] = "nessie"
    # CONFIG["policy_test_type"] = "online_nessie"
    CONFIG["policy_test_index"] = 80
    ...
    for run in range(CONFIG["num_runs"]):
        ...
        for episode_number in range(CONFIG["num_episodes"]):
            ...
            if CONFIG["test_policy"]:
                ...
                elif CONFIG["policy_test_type"] == "nessie" or CONFIG["policy_test_type"] == "online_nessie":
            ...
            nessie.pilot([0, 0, 0, 0, 0, possible_starting_states[episode_number]])
            rospy.sleep(2.0)
