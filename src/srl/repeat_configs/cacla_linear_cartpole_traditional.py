...
controlled_var = makeRange([24, 4, 8, 16, 24, 32], 5)
actor_config = {
    ...
    "num_input_dims": 4,
    "num_hidden_units": controlled_var
    ...
    while not rospy.is_shutdown():
        ...
        for run in range(CONFIG["num_runs"]):
            ...
            if CONFIG["linear policy"]:
                ...
                policy = ANNApproximator(CONFIG["actor_config"]["num_input_dims"], CONFIG["actor_config"]["num_hidden_units"][run], hlayer_activation_func="tanh")
